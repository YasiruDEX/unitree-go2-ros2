# ros2 launch spark_fast_lio mapping_gazebo.launch.yaml
...
def generate_launch_description():
    ...
    default_world_path = os.path.join(config_pkg_share, "worlds/basic.world")
    rviz_config_path = "/home/yasiru/Documents/ros2_ws2/install/fast_lio/share/fast_lio/rviz/fastlio2.rviz"
    ...
    fast_lio_launch = IncludeLaunchDescription(
	    PythonLaunchDescriptionSource(
		os.path.join(
		    get_package_share_directory("fast_lio"),  # package containing the launch file
		    "launch",
		    "mapping.launch.py"
		)
	    ),
    ...
    teleop_node = Node(
        ...
        prefix = 'xterm -e',
        output='screen',
        remappings=[('/cmd_vel', '/cmd_vel')]  # Using the standard topic name
    )
